...
import net.trique.mythicupgrades.item.ModArmorMaterials;

import java.util.Map;

public class AmetrineJumpBoost extends ArmorItem {
    public static final int effectDuration = 400;
    public static final int amplifier = 0;

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.AMETRINE_NETHERITE,
                            new StatusEffectInstance(StatusEffects.JUMP_BOOST, effectDuration, amplifier)).build();

    public AmetrineJumpBoost(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
