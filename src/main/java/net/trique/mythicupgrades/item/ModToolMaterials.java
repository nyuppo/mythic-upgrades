...
public enum ModToolMaterials implements ToolMaterial {
    ...
    RUBY_NETHERITE(MiningLevels.NETHERITE, 2031, 13.0f, 4.0f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    TOPAZ_NETHERITE(MiningLevels.NETHERITE, 6093, 9.0f, 4.0f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    SAPPHIRE_NETHERITE(MiningLevels.NETHERITE, 2031, 9.0f, 5.0f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
